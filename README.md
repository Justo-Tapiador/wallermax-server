...
**Status: v0.15.0 — the roadmap phases done, a dynamic template engine with require() running on the original node-jhs2 engine, 
...
```console
$ cargo run
   Compiling wallermax-server v0.15.0
...
INFO wallermax_server::server: wallermax-server listening address=127.0.0.1:8080 version=0.15.0
...
{"status":"ok","version":"0.15.0","template_backend":"sidecar"}
...
```json
// GET /api
{"service":"wallermax-server","version":"0.15.0","description":"...","endpoints":["GET / (static index + files)","GET /api","GET /health","GET /api/stats","POST /api/echo","GET /metrics","POST /api/auth/register","POST /api/auth/login","GET /api/auth/me","GET /api/admin/users","POST /api/auth/refresh","POST /api/auth/logout","POST /api/auth/logout_all"]}

// GET /health
{"status":"ok","version":"0.15.0","template_backend":"sidecar"}

// GET /api/stats
{"service":"wallermax-server","version":"0.15.0","uptime_seconds":10.244,"total_requests":12,"requests_per_second":1.171,"rate_limited_requests":0,"registered_users":2}
